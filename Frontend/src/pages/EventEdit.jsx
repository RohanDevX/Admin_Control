...
export default function EventEdit() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const formattedDate = data.event_date ? new Date(data.event_date).toISOString().split('T')[0] : "";

        setForm({
          ...data,
          event_date: formattedDate,
          priority: data.priority === true ? "High" : "Low",
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const payload = { ...form, priority: form.priority === 'High' };
      ...
      <form className="ef-card" onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <label className="ef-field">
            ...
            >
                ...
                {/* Only populate if a category is selected and exists in the map */}
        ...
        <label className="ef-field">
            Status
            <select name="status" value={form.status || 'Upcoming'} onChange={handleChange} required>
        ...
        <label className="ef-field">
            Priority
            <select name="priority" value={form.priority || 'Low'} onChange={handleChange} required>
        ...
        <label className="ef-field ef-full">
          ...
          <div className="file-upload-wrapper">
            ...
            <input id="event_image" type="file" name="event_image" className="file-input-hidden" accept="image/*" onChange={handleFileChange} />
